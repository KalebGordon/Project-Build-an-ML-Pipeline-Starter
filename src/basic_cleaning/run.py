...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_description", 
        type=str,
        help="Description of the output artifact (e.g., dataset after basic cleaning)",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type=float,
        help="Minimum price threshold for data filtering",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Maximum price threshold for data filtering",
        required=True
    )
